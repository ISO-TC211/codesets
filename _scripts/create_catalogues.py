...
header = f'''
    ...
    cat:
        a dcat:Catalog ;
        schema:name "ISO/TC211 Codelist Vocabularies" ;
...
ISO/TC211 standards of the ISO 19* series are about "Geographic information/Geomatics". Many of those standards contain codelists of terms that are used within the standards' data models. For example, the standard [ISO 19115-1:2014
...
Such unauthorised republications of ISO content are not allowed by ISO licensing. We encourage people wanting more ISO material delivered as machine-readable objects to contact the Group on Ontology maintenance, see this catalogue's publisher details for contact information.""" ;
        skos:historyNote "This catalogue was assembled from all the vocabularies made available by ISO/TC211's Group on Ontology Maintenance"@en ;
